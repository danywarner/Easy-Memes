...
function fillGrid(){    
    ...
    for(var s=1;s<=pages+1;s++){
        ...
        if((screenWidth == 320 || screenWidth == 768) && strings[i]=="chencho.jpg"){
            break;
        }
